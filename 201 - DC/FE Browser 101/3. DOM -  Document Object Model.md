...
한번 업데이트 될 때 16ms 안에 이루어져아야 사용자가 보기 편하다. 
Layout Shift: 뭐가 어떻게 바뀌었는지 상세하게 볼 수 있다. 

Rendering: Show layout shift regions: layout이 어떻게 발생하고 있는지 나온다. 마우스가 움직일 때마다 레이아웃이 계속해서 발생하는 경우는 좋지 않은 경우.  

4.10 DOM 조작하기

4.11 innerHTML vs element 어떤 걸 쓰지?
